...
root = "/mnt/shared"
exampleutils.generate_ssn_data(1, root)
exampleutils.generate_ssn_data(2, root)
exampleutils.generate_ssn_data(3, root)

left = read_rel("/mnt/shared/1000/in1.csv")
right = read_rel("/mnt/shared/1000/in2.csv") + read_rel("/mnt/shared/1000/in3.csv")
