...
def protocol_mpc():
    ...
    left_shared_pids = cc._pub_intersect(
        left_keys, "a_left_shared_pids", pid_col_meds, host='localhost')
    cc._persist(left_shared_pids, "a_left_shared_pids")
    right_shared_pids = cc._pub_intersect(
        right_keys, "a_right_shared_pids", pid_col_meds, is_server=False, host='localhost')
    ...
    left_join = cc._pub_join(left_medication_shared, "left_join", pid_col_meds,
                             other_op_node=left_diagnosis_shared, host='localhost')
    right_join = cc._pub_join(right_medication_shared, "right_join", pid_col_meds, is_server=False,
                              other_op_node=right_diagnosis_shared, host='localhost')
...
def run_mpc(pid: str, data_root: str):
    ...
    conclave_config.input_path = "/Users/ben/Desktop/data/100000/"
    conclave_config.output_path = "/Users/ben/Desktop/data/100000/"
