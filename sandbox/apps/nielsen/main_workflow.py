...
def protocol():
    ...
    concatenated_DFs = sal.create('concatenated_DFs', cols_concatenated_DFs, {1})

    # the output of preprocess_products.py
    temp_UPC_brandBU_crspnd = sal.create('temp_UPC_brandBU_crspnd', cols_temp_UPC_brandBU_crspnd, {1})
    ...
    brnd_p_sum = sal.aggregate(w_wghtd_OZ_brnd_p_final, 'brnd_p_sum',
                               ['store_code_uc', 'brand_code_bu', 'week_end'],
                               'wghtd_OZ_brnd_p', 'sum', 'avg_OZ_brnd_p')
    ...
    wghtd_p_sum = sal.aggregate(wghtd_p_final, 'wghtd_p_sum',
                                ['store_zip3', 'retailer_code', 'brand_code_bu', 'week_end'], 'wghtd_p', 'sum', 'p')
    ...
    return {concatenated_DFs, temp_UPC_brandBU_crspnd}
