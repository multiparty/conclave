...
def protocol():
    ...
    create = sal.create("movement", colsInA, {1})
    ...
    sum_units = sal.aggregate(w_unit_p, 'sum_units', ['store_code_uc', 'upc', 'week_end'], 'units', 'sum', 'q')
