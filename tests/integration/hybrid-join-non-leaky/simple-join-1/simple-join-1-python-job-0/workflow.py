...
if __name__ == "__main__":
    print("start python")
    left = read_rel('/home/sharemind/Desktop/conclave/tests/integration/hybrid-join-non-leaky/data/left.csv')
    right = read_rel('/home/sharemind/Desktop/conclave/tests/integration/hybrid-join-non-leaky/data/right.csv')
    expected  = join(left, right, 0, 0)
    write_rel('/home/sharemind/Desktop/conclave/tests/integration/hybrid-join-non-leaky/data', 'expected.csv', expected, '"a","b","d"')
